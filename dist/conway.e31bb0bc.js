...
function () {
  ...
  _createClass(Game, [{
    ...
    key: "cloneTable",
    value: function cloneTable() {
      var newTable = [];

      for (var i = 0; i < this.height; i++) {
        newTable.push(this.table[i].slice(0));
      }
    ...
    value: function advance() {
      ...
      for (var i = 0; i < this.height; i++) {
        for (var j = 0; j < this.width; j++) {
          ...
          if (this.isAlive(i + 1, j)) neighbours++;
          if (this.isAlive(i, j) && neighbours < 2) newTable[i][j] = 0;else if (this.isAlive(i, j) && neighbours >= 2 && neighbours <= 3) newTable[i][j] = 1;else if (this.isAlive(i, j) && neighbours > 3) newTable[i][j] = 0;else if (!this.isAlive(i, j) && neighbours === 3) newTable[i][j] = 1;
        }
      }
...
//# sourceMappingURL=/conway.e31bb0bc.map